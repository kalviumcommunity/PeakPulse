...
type Page = 'landing' | 'signin' | 'dashboard' | 'ml-predictor' | 'risk-monitor' | 'operations' | 'zones' | 'incidents' | 'reports'
const PROTECTED: Page[] = ['dashboard', 'ml-predictor', 'risk-monitor', 'operations', 'zones', 'incidents', 'reports']
