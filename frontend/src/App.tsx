...
type Page = 'landing' | 'signin' | 'dashboard' | 'risk-monitor' | 'operations' | 'zones' | 'incidents' | 'reports'
const PROTECTED: Page[] = ['dashboard', 'risk-monitor', 'operations', 'zones', 'incidents', 'reports']
